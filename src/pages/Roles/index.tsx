...
export default function Roles() {
  ...
  const {data: roles, isFetching} = useQuery<TRole[]>({
    queryKey: ['get-organization-roles'], async queryFn() {
      return (await httpCommon.get(`role/by-organization/${user?.user_organization[0].organizationId}`)).data;
    }
  })
  ...
  return <div>
    ...
    <div className="my-4 p-2">
      {isFetching ? <Loader/> : <div className={'w-full overflow-hidden rounded border'}>
        <Table>
          <TableHeader>
